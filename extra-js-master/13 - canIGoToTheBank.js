...
console.log(canIGoToTheBank3("Sunday", 10));

const canIGoToTheBank4 = (day, time) => {
  if ((day.toLowerCase() !== "saturday" && day.toLowerCase() !== "sunday") && (time >= 10 && time <= 18 )) {
...
console.log(canIGoToTheBank4("SuNday", 10));